...
class TestHedVersion(TestCase):
    ...
    def test_constructor(self):
        ...
        print(f"HED version: {str(hed_version1.hed_version)}")
        print(f"{str(hed_version1)}")
        self.assertIsInstance(hed_version1.hed_version, list)
...
class TestHedAnnotationsConstructor(TestCase):
    ...
    def test_constructor(self):
        ...
        assert hed_annotations.name == "HED"
        assert hed_annotations.description == "description"
        assert hed_annotations.hed_strings == ["animal_target, correct_response", "animal_target, incorrect_response"]
...
#         
#         # TODO: How to require col_cls to be HedAnnotations?
